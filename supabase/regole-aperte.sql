...
-- Si rimette anche il ponte che la chiusura aveva tolto, o la strada del
-- ritorno sarebbe a metà: chi ha il telefono agganciato male resterebbe
-- fuori anche a porte spalancate.
